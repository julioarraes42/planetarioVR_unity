...
public class AsteroidBeltGenerator : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < cubeDensity; i++)
        {
            ...
            _asteroid.AddComponent<AsteroidBeltObject>().SetupAsteroidBeltObject(Random.Range(minOrbitSpeed, maxOrbitSpeed), Random.Range(minRotationSpeed, maxRotationSpeed), gameObject, rotatingClockwise);
